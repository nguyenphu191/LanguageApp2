...
import 'package:language_app/hung_nm/profile/activity.dart';
...
import 'package:language_app/hung_nm/profile/add_fr.dart';
import 'package:language_app/hung_nm/profile/setting/setting_screen.dart';
import 'package:language_app/hung_nm/profile/friends_list_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget _buildAddFriendAndShareSection(Size size, double pix) {
    return Column(
      children: [
        // Hàng trên: nút Thêm bạn (chiếm toàn bộ chiều ngang)
        _buildActionButton(
          pix,
          'Thêm bạn bè',
          Icons.person_add,
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _buildAchievementBadge(pix, 'Học liên tục', '7 ngày',
                  'lib/res/imagesLA/coviet.png', true),
              _buildAchievementBadge(pix, 'Từ vựng', '100 từ',
                  'lib/res/imagesLA/coviet.png', true),
              _buildAchievementBadge(pix, 'Phát âm', 'Hoàn thành',
                  'lib/res/imagesLA/coviet.png', true),
              _buildAchievementBadge(pix, 'Ngữ pháp', 'Cơ bản',
                  'lib/res/imagesLA/coviet.png', false),
              _buildAchievementBadge(pix, 'Nghe hiểu', 'Trung cấp',
                  'lib/res/imagesLA/coviet.png', false),
              _buildAchievementBadge(pix, 'Giao tiếp', 'Sơ cấp',
                  'lib/res/imagesLA/coviet.png', false),
            ],
          ),
        ],
