...
class FlashCard extends StatelessWidget {
  ...
  Widget _buildCardContent(
    ...
    return Container(
      ...
      padding: EdgeInsets.only(top: 16 * pix, left: 8 * pix, right: 8 * pix),
        ...
        child: Column(
          ...
          children: [
            AutoSizeText(
              ...
              minFontSize: 16, // Giá trị cố định, không nhân với pix
              maxFontSize: 32,
              stepGranularity: 1.0,
            ),
            ...
            image == ""
                ? Text(
                    "?",
                    style: TextStyle(
                      fontSize: 96 * pix, // Reduced font size
                      color: Colors.white,
                      fontFamily: 'BeVietnamPro',
                      fontWeight: FontWeight.bold,
                    ),
            ...
            Padding(
              ...
              child: AutoSizeText(
                ...
                overflow: TextOverflow.ellipsis,
                textAlign: TextAlign.center,
                minFontSize: 12, // Giá trị cố định, không nhân với pix
                maxFontSize: 18,
                stepGranularity: 1.0,
              ),
            ),
